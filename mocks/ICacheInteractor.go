...
import cache "github.com/bxcodec/httpcache/cache"
...
func (_m *ICacheInteractor) Set(key string, value cache.CachedResponse, duration time.Duration) error {
	ret := _m.Called(key, value, duration)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, cache.CachedResponse, time.Duration) error); ok {
